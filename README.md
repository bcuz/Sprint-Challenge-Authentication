...
They're used to persist auth info so the user doesn't have to re-enter credentials on every new page they visit. 
1. What does bcrypt do to help us store passwords in a secure manner.
It hashes the password multiple times and adds a salt.
1. What does bcrypt do to slow down attackers?
It hashes the password multiple times to increase the computation time required to hash each password.
